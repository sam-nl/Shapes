...
public class ClosedShape {
	...
	/**
	 * increases the size of the shape slightly
	 */
	public void grow() {
		System.out.println("overwrite grow() in closed shape's child");
	}
	/**
	 * decreases the size of the shape slightly
	 */
	public void shrink() {
		System.out.println("overwrite shrink() in closed shape's child");
	}
